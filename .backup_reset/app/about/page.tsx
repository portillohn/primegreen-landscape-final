      ...
      <section className="py-24 bg-gray-50 border-t border-gray-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn className="bg-white rounded-3xl p-8 md:p-12 shadow-md flex flex-col md:flex-row items-center gap-10">
            <div className="shrink-0 w-48 h-48 bg-brand-dark rounded-full flex items-center justify-center p-8 border-4 border-brand-accent shadow-lg relative">
              <Leaf className="w-full h-full text-brand-bg opacity-80" />
            </div>
            <div>
