    ...
    <>
      ...
      <section className="relative pt-32 pb-24 bg-brand-dark overflow-hidden text-inter">
        <div className="absolute inset-0 z-0">
          <Image src="https://images.unsplash.com/photo-1596733430284-f7437764b1a9?w=1600&q=80" alt="Perfectly edged driveway" fill className="object-cover opacity-20" priority />
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative z-10 aspect-square rounded-2xl overflow-hidden border-8 border-white shadow-lg">
                <Image src="https://images.unsplash.com/photo-1592419044706-39796d40f98c?w=1600&q=80" alt="Sharp bed edging" fill className="object-cover" />
              </div>
            </div>
          </div>
        </div>
