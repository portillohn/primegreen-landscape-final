...
const services = [
  ...
  },
  {
    title: "STANDARD CARE",
    price: "$65",
    features: ["Everything in Basic", "Full edging (walkways, driveway, beds)", "Sidewalk blowdown"],
    popular: true
  },
  {
    title: "PREMIUM MANICURE",
    price: "$95",
    features: ["Everything in Standard", "Detail trimming around all obstacles", "Bed border cleanup"],
  }
];
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <FadeIn direction="right" className="relative">
              ...
              <div className="relative z-10 bg-white rounded-2xl p-8 md:p-12 shadow-2xl border border-gray-100">
      ...
      <section className="py-24 bg-brand-dark text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <FadeIn delay={0.1} className="bg-white/5 backdrop-blur-sm p-10 rounded-3xl border border-white/10 hover:border-brand-accent/50 transition-colors">
            ...
            <FadeIn delay={0.2} className="bg-white/5 backdrop-blur-sm p-10 rounded-3xl border border-white/10 hover:border-brand-accent/50 transition-colors">
            ...
            <FadeIn delay={0.3} className="bg-white/5 backdrop-blur-sm p-10 rounded-3xl border border-white/10 hover:border-brand-accent/50 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {services.map((service, idx) => (
              <FadeIn key={idx} delay={idx * 0.1} className={`relative bg-white rounded-3xl p-8 shadow-xl flex flex-col border-2 ${service.popular ? 'border-brand-mid scale-105 z-10' : 'border-gray-50'}`}>
                {service.popular && (
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <FadeIn className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-black text-brand-dark mb-6">Areas We Handle & Common Questions</h2>
            <p className="text-lg text-gray-600">Specific details for our {cityData.name} clients.</p>
          </FadeIn>
